<template>
  <a
    ...
    class="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-deep-forest/20 backdrop-blur-sm border border-deep-forest/30 text-deep-forest font-label text-label tracking-[0.1em] hover:bg-deep-forest/30 hover:border-deep-forest/50 transition-all active:scale-95"
  >
